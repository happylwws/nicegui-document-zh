...
创建一个渲染 Matplotlib 图形的 Matplotlib 元素。
当离开图形上下文时，图形会自动更新。

|  参数 | 描述 |
| --- | --- |
| kwargs: | 类似于 `figsize` 的参数，这些参数应该传递给 [`matplotlib.figure.Figure`](https://matplotlib.org/stable/api/figure_api.html#matplotlib.figure.Figure) |
